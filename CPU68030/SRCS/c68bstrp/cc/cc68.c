...
/*  driver modified by Laurent Vogel to run C68 as described by ?
 *
 *  call this new driver /usr/bin/c68 or else modify the "c68" in
 *  the line that says :
...
struct passinfo passinfo[] = {
	...
	{ "c68", C68, "i,c", "s", "Q*,O", INPUT|OUTPUT|PREPALWAYS },
