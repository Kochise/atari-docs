 ...
 *
 *	Most of the test data in the current data file (c2c.dat)
 ...
 *	may be redirected to the provided test file (c2c.dat),
...
static struct test tests[] = {	/* Table of all recognized functions */
    "cacos", cacos, 0.0, 	/* Complex arc cosine */
    "casin", casin, 0.0, 	/* Complex arc sine */
    "catan", catan, 0.0, 	/* Complex arc tangent */
    "ccos", ccos, 0.0,	 	/* Complex cosine */
    "ccosh", ccosh, 0.0,	/* Complex hyperbolic cosine */
    "cexp", cexp, 0.0, 		/* Complex exponential */
    "clog", clog, 0.0, 		/* Complex natural logarithm */
    "crcp", crcp, 0.0, 		/* Complex reciprocal */
    "csin", csin, 0.0, 		/* Complex sine */
    "csinh", csinh, 0.0, 	/* Complex hyperbolic sine */
    "csqrt", csqrt, 0.0, 	/* Complex square root */
    "ctan", ctan, 0.0, 		/* Complex tangent */
    "ctanh", ctanh, 0.0, 	/* Complex hyperbolic tangent */
 ...
 *  FUNCTION
 *
 *	main   entry point for c2c test utility
 *
 *  PSEUDO CODE
 *
 *	Begin main
...
char *argv[];
{
    ...
    save_stdin = stdin;
    re_stdin = freopen("c2c.dat","r",stdin);
	...
	sscanf (buffer, "%s %le %le %le %le", function,
	&argument.real, &argument.imag, &expected.real, &expected.imag);
	    ...
	    if (vflag) {
	        printf ("%s(%le + j %le) \n   = %30.23le + j %30.23le.\n",
		function, argument.real, argument.imag, result.real,
		result.imag);
	    }
