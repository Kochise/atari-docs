#define RCS_ID "$Id: scc.c,v 1.61 1996/10/05 17:46:45 jreuter Exp jreuter $"

#define BANNER "Z8530 SCC driver version 2.4.dl1bke (experimental) by DL1BKE\n"
...
/*
   ...
   ******************************************************************** 
   ...
   PA3GCU Richard - for support and finding the "grouping" bug.
   ...
   NB -- if you find errors, change something, please let me know
   	 ...
   	 "v2.4.dl1bke" with your own. Just to avoid confusion...
